          ...
          <div className="bg-gradient-to-br from-emerald-600 to-teal-700 rounded-[2.5rem] p-8 md:p-12 text-white shadow-2xl relative overflow-hidden flex flex-col md:flex-row gap-8 items-center border border-emerald-500/30">
            ...
            <div className="flex-1 relative z-10 w-full">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                <div className="bg-black/10 backdrop-blur-sm rounded-2xl p-5 border border-white/10 transition-transform hover:-translate-y-1">
                  ...
                  <p className="font-bold text-xl text-white">{userPengajuan.posisi_id?.nama_posisi || userPengajuan.detail_tempat?.posisi || 'Posisi Magang'}</p>
                </div>
                <div className="bg-black/10 backdrop-blur-sm rounded-2xl p-5 border border-white/10 transition-transform hover:-translate-y-1">
                  ...
                  <p className="font-bold text-xl text-white">{userPengajuan.dpl_id?.nama_lengkap || 'Belum ditugaskan'}</p>
                </div>
              </div>
            </div>
